...
import { NavBtn } from "../header";

type WikiNavProps = {
  responsive: Responsive;
};

const WikiNav = ({ responsive }: WikiNavProps) => {
  ...
  return (
    <nav className="wiki_page_nav">
      <NavBtn
        path={"/wiki/controller"}
        className={"controller_wiki_nav"}
        content={
          responsive.width ? (
            "controller"
          ) : (
